...
console.log("Самый дорогой заказ сделал- " + highestOrderCustomer +" " + highestOrder);
console.log("Проданные товары и их количество:");
...
for (var product in productCounts) {
  ...
  console.log("Самый популярный товар: " + popularProduct);